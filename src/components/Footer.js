...
export default function Footer() {
  ...
  return (
    <>
        <section className={`md:flex md:justify-between ease-in-out duration-300 ${isDarkMode ? 'bg-[#212121]' : 'bg-white'}`}>
            ...
            <div className='md:border-none border-dotted border-white border-[1px] opacity-25 mt-5'></div>
        ...
        <footer style={{ backgroundColor: isDarkMode ? '#181818' : 'white' }} className={`${isDarkMode ? 'text-gray-500' : 'text-black'} text-center text-[15px] py-4`}>
            <p>Copyright &copy; {new Date().getFullYear()} Rigel Ramadhani Waloni.</p>
        </footer>
    </>
  );
}
